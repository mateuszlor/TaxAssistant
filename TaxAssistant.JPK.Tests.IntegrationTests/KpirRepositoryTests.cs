...
{
    public class KpirRepositoryTests
    {
        private DatabaseContext _databaseContext;
        private IDomainEventDispatcher _eventDispatcher;
        private ILogger<KpirRepository> _logger;
        private KpirRepository _sut;
        ...
        public void Setup()
        {
            ...
            _logger = Substitute.For<ILogger<KpirRepository>>();

            _sut = new KpirRepository(_databaseContext, _eventDispatcher, _logger);
        }
