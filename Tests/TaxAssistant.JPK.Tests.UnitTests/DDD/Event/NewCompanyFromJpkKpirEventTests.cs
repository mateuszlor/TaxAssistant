...
{
    public class NewCompanyFromJpkKpirEventTests
    {
        [Test]
        ...
        public void Equals_ForDifferentNameAndSameAddress_ReturnsFalse()
        {
            // Arrange
            var company1 = new NewCompanyFromJpkKpirEvent("some company", "00-000 City Street 1/2");
            var company2 = new NewCompanyFromJpkKpirEvent("some company with other name", "00-000 City Street 1/2");
        ...
        public void Equals_ForSameNameAndDifferentAddress_ReturnsFalse()
        {
            // Arrange
            var company1 = new NewCompanyFromJpkKpirEvent("some company", "00-000 City Street 1/2");
            var company2 = new NewCompanyFromJpkKpirEvent("some company", "01-000 OtherCity OtherStreet 3/4");
        ...
        {
            // Act
            var result = new NewCompanyFromJpkKpirEvent($"Monsters Inc.{Environment.NewLine}1234567890", "00-000 City Street 1/2");
        ...
        {
            // Act
            var result = new NewCompanyFromJpkKpirEvent($"Monsters Inc.{Environment.NewLine}NIP: 1234567890", "00-000 City Street 1/2");
        ...
        {
            // Act
            var result = new NewCompanyFromJpkKpirEvent($"John Doe{Environment.NewLine}PESEL: 12345678910", "00-000 City Street 1/2");
        ...
        {
            // Act && Assert
            var action = () => new NewCompanyFromJpkKpirEvent(null, "00-000 City Street 1/2");
        ...
        {
            // Act && Assert
            var action = () => new NewCompanyFromJpkKpirEvent(string.Empty, "00-000 City Street 1/2");
            action.Should().Throw<ArgumentNullException>();
        }
        ...
        {
            // Act && Assert
            var action = () => new NewCompanyFromJpkKpirEvent("   ", "00-000 City Street 1/2");
            action.Should().Throw<ArgumentNullException>();
        }
    }
}